                            ...
                            <div class="card-body">
                                <form action="add_user.php" method="POST" >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="confirmpassword" />
                                    ...
                                    <div class="form-group mt-4 mb-0">
                                      <button type="submit" class="btn btn-secondary btn-block"  style="background-color: #673AB7; border-color: #673AB7" >Create Account</button>
                                    </div>
                                </form>
                            </div>
