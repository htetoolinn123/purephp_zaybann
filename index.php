		    ...
		    <div class="col-lg-4 col-sm-6 portfolio-item">
		        <div class="card h-100 ">
			        ...
			        <div class="card-footer bg-transparent">
						...
						<?php } else { ?>
								<a href="login" class="btn btn-secondary btn-block" data-toggle="tooltip" data-placement="top" title="If you want to order,You must need to be our member" style="background-color: #673AB7; border-color: #673AB7">
