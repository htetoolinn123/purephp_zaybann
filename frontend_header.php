        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item px-3 <?php if ($route=='mycart') {echo "active"; } else  {echo "";}?>">
            <a class="nav-link" href="cart"> 
              ...
              <span id="booking" class="badge badge-pill badge-light badge-notify cartnoti"></span>
              My Cart 
            </a>
          </li>
          ...
          <li class="nav-item dropdown <?php if ($route=="account") {echo "active"; } else  {echo "";}?>">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
              ...
              <a class="dropdown-item <?php if ($sub_route=='order') {echo "active"; } else  {echo "";}?>" href="myorder">
                <i class="fas fa-box pr-3"></i>
                My Orders
              </a>
              <div class="dropdown-divider"></div>
